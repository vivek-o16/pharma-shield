    ...
    return `
      <article class="result-card status-alert" role="alert">
        ...
        <p class="result-message">
          This medicine/batch has been reported in a CDSCO quality alert.
        </p>
        ...
        ${
          DB.isDemoData
            ? '<p class="result-note">This result is based on demo sample data included with the project, not a live CDSCO feed.</p>'
            : ""
        }
      </article>`;
  }
